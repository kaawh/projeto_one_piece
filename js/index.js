// janela de alerta quando o site é aberto com o window.alert() :
...
// forEach: é uma ação de iteração que executa uma função para cada elemento, seja de arrays simples ou arrays de objetos.

// pegar a classe botao do html: 
